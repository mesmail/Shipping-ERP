...
@section('title', app()->getLocale() === 'ar' ? 'إضافة فرع' : 'Add Branch')
@section('page-title', app()->getLocale() === 'ar' ? 'إضافة فرع' : 'Add Branch')
...
<div class="space-y-6">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500">
        ...
        <i class="fa-solid fa-chevron-{{ app()->getLocale() === 'ar' ? 'left' : 'right' }} text-xs"></i>
        <span class="text-gray-900 font-medium">{{ app()->getLocale() === 'ar' ? 'إضافة فرع' : 'Add Branch' }}</span>
    </nav>
                ...
                <div class="card">
                    <div class="card-body space-y-3">
                        <button type="submit" class="btn-primary w-full justify-center btn-lg">
                            ...
                            {{ app()->getLocale() === 'ar' ? 'حفظ الفرع' : 'Save Branch' }}
                        </button>
